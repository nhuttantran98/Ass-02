...
Menu:
	...
	case 3: {
		...
		//================= menu chinh cua doc gia============

	menu_docgia: 
		system("cls");

		// hien thi menu doc gia va nhap lua chon
		menu_dn_docgia();
		cout << "Moi ban nhap lua chon:"; cin >> selectVar;
		while ((selectVar < 1) || (selectVar > 4)) {
			cout << "Lua chon khong chinh xac moi nhap lai:";
			cin >> selectVar;
		}
		system("cls");
		...
		switch (selectVar) {
			...
			//*** xem va sua thong tin tai khoan ***
		case 1: {
		thongtin_nd:
			system("cls");
			cout << "======================================" << endl;
			cout << "1.Xem thong tin." << endl << endl;
			cout << "2.Sua thong tin." << endl << endl;
			cout << "3.Tro lai." << endl << endl;
			cout << "======================================" << endl;
			cout << "Moi ban nhap lua chon:"; cin >> selectVar;
			while ((selectVar < 1) || (selectVar > 3)) {
				cout << "Lua chon khong chinh xac moi nhap lai:";
			...
			if (selectVar == 1) {
				...
				cout << "chon 7 de tro lai: "; cin >> selectVar;
				while (selectVar != 7) {
					cout << "Nhap sai! Chon 7 de tro lai: "; cin >> selectVar;
				}
				system("cls");
				goto thongtin_nd;
			}
			...
			// sua thong tin
				...
				if (selectVar != 7) {
					...
					//Tien hanh chinh sua
					Setting(dataUser[ID_Login], selectVar);
		...
		case 2: {
			/*while (in) {
				...
				cout << "Moi ban nhap lua chon:"; cin >> selectVar;
				while ((selectVar < 1) || (selectVar > 3)) {
					cout << "Ban da nhap sai, moi nhap lai: "; cin >> selectVar;
				}
				system("cls");
				switch (selectVar)
				{
		...
		case 3: {
			do {
				system("cls");
				UM_SelectedAcc(dataAccount, ID_Login);
				cout << "\nTHIET LAP LAI MAT KHAU\n";
				cout << "=======================================================================\n";
				cout << "\nBAN CHAN CHAN MUON THIET LAP LAI MAT KHAU CHO TAI KHOAN NAY?\n";
				cout << "\n1.Co\n";
			...
			//Tien hanh nhap mat khau moi
			if (selectVar == 1) {
				char newpass[maxElements];
				cin.ignore();
				cout << "Nhap mat khau moi:"; cin.getline(newpass, maxElements);
